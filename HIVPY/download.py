...
all_accessions = [
    ...
    # 患者H
    "M90907.1", "M90908.1", "M90909.1", "M90910.1", "M90911.1", "M90912.1",
    # 本地对照
...
sequence_mapping = {
    ...
    # 患者H
    "M90907.1": ("患者H", "克隆序列"), "M90908.1": ("患者H", "克隆序列"),
    "M90909.1": ("患者H", "克隆序列"), "M90910.1": ("患者H", "克隆序列"),
    "M90911.1": ("患者H", "克隆序列"), "M90912.1": ("患者H", "克隆序列"),
